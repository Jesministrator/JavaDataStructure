package com.wxueyuan.dailyPractice;
...
public class MyBinaryTree<E> {
	...
	class TreeTraversal {
		...
		//Recursion Traversal
		public List<E> preTraversalRecursion(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		
		public List<E> inTraversalRecursion(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		
		public List<E> postTraversalRecursion(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		
		//Non Recursion Traversal
		public List<E> preTraversalNonRecursion(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		public List<E> inTraversalNonRecursion(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		public List<E> postTraversalNonRecursion(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		
		//Moris Traversal
		public List<E> preTraversalMoris(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		public List<E> inTraversalMoris(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		public List<E> postTraversalMoris(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		
		//level Traversal
		public List<E> levelTraversalRecursion(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		public List<E> levelTraversalNonRecursion(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
		public List<E> levelTraversalZigZag(E v){
			List<E> list = new ArrayList<>();
			return list;
		}
	...
	public List<E> preTraversalRecursion(E v){
		...
		preRecursion(parent,list);
		return list;
	}
	private void preRecursion(Node parent,List<E> list){
		if(parent==null) return;
		list.add(parent.data);
		preRecursion(parent.left,list);
		preRecursion(parent.right, list);
	}
	public List<E> inTraversalRecursion(E v){
		List<E> list = new ArrayList<>();
		Node parent = getNodeByValue(v);
		inRecursion(parent,list);
		return list;
	}
	private void inRecursion(Node parent,List<E> list){
		if(parent==null) return;
		inRecursion(parent.left,list);
		list.add(parent.data);
		inRecursion(parent.right, list);
	}
	public List<E> postTraversalRecursion(E v){
		List<E> list = new ArrayList<>();
		Node parent = getNodeByValue(v);
		postRecursion(parent,list);
		return list;
	}
	private void postRecursion(Node parent,List<E> list){
		if(parent==null) return;
		postRecursion(parent.left,list);
		postRecursion(parent.right, list);
		list.add(parent.data);
	}
	...
	public List<E> levelTraversalNonRecursion(E v){
		...
		for(int i=1;i<=height;i++){
			levelRecur(current, i, list);
		}
		return list;
	}
	private void levelRecur(Node n, int level, List<E> list){
		if(n==null || level<1) return;
		if(level==1){
			list.add(n.data);
		}
		levelRecur(n.left, level-1, list);
		levelRecur(n.right, level-1, list);
	}
	public List<E> levelTraversalZigZag(E v){
		List<E> list = new ArrayList<>();
		Node current = getNodeByValue(v);
